...
/** Se agrega la libreria PHPExcel */
    ...
    ->setTitle("Reporte General Comision por Empleado Diaria") // Titulo
    ->setSubject("Reporte General Comision por Empleado Diaria") //Asunto
    ->setDescription("Reporte de Comision por Empleado Diaria") //Descripción
    ->setKeywords("Reporte de Comision por Empleado Diaria") //Etiquetas
    ->setCategory("Reporte de Comision por Empleado Diaria"); //Categorias

    $tituloReporte = "Reporte General de Comision por Empleado Diaria";
	$titulosColumnas = array('EMPLEADO_ID', 'NOMBRE_EMPLEADO', 'TOTAL_COMISION_DIARIA');
	...
	$objPHPExcel->getActiveSheet()->setTitle('Comision_por_Empleado_Diaria');
...
<div class="box">
	...
	<h1 class="title">Comisión por Empleado Diaria</h1>
	<hr>
...
<div class="body">
			...
			<div class="sky-tabs sky-tabs-pos-top-left sky-tabs-anim-flip sky-tabs-response-to-icons">
				...
				<label for="sky-tab1"><span><span><i class="fa fa-bolt"></i>Reporte General de Comision por Empleado Diaria</span></span></label>
				
				<ul>
					<li class="sky-tab-content-1">					
						<div class="">
							<h4>Reporte General de Comision por Empleado Diaria</h4>
						  ...
						  <table class="tableData">
										<tr class="TableHeader">
											...
											<td><span class="ColumnHeader"><STRONG>COMISION TOTAL</STRONG></span></td>
