...
/** Se agrega la libreria PHPExcel */
    ...
    ->setTitle("Reporte General Movimiento de Efectivo Total por Kiosco") // Titulo
    ->setSubject("Reporte General Movimiento de Efectivo Total por Kiosco") //Asunto
    ->setDescription("Reporte de Movimiento de Efectivo Total por Kiosco") //Descripción
    ->setKeywords("Reporte de Movimiento de Efectivo Total por Kiosco") //Etiquetas
    ->setCategory("Reporte de Movimiento de Efectivo Total por Kiosco"); //Categorias

    $tituloReporte = "Reporte General de Movimiento de Efectivo Total por Kiosco";
	$titulosColumnas = array('KIOSCO ID', 'DESCRIPCION_KIOSCO', 'MONTO_TOTAL');
    ...
    $queryText_Reporte = "
						...
						WHERE tm.Kiosco_ID_Kiosco = '".$ID_KC."' and tm.ID_Tipo_Transaccion_Monetaria = 1;
   						";
    ...
    $i = 4; //Numero de fila donde se va a comenzar a rellenar
	 while ($Data_Record = mysqli_fetch_array($Resultado_Data)) {
	     $objPHPExcel->setActiveSheetIndex(0)
	         ...
	         ->setCellValue('D'.$i, $Data_Record['Total_Dia']);
	     $i++;
	 }
...
<div class="box">
	...
	<h1 class="title">Movimiento de Efectivo Total por Kiosco</h1>
	<hr>
...
<div class="body">
			...
			<div class="sky-tabs sky-tabs-pos-top-left sky-tabs-anim-flip sky-tabs-response-to-icons">
				...
				<label for="sky-tab1"><span><span><i class="fa fa-bolt"></i>Reporte General Movimiento de Efectivo Total por Kiosco</span></span></label>
				
				<ul>
					<li class="sky-tab-content-1">					
						<div class="">
							<h4>Reporte General Movimiento de Efectivo Total por Kiosco</h4>
						  ...
						  <table class="tableData">
									...
									?>
											<tr class="<?php echo($tabledetailclass); ?>">
												...
												<td><?php echo($Parqueo_Record["Total_Dia"]);?></td>
												</td>												
											</tr>
									<?php
										$i++;
