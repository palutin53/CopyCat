...
/** Se agrega la libreria PHPExcel */
    ...
    ->setTitle("Reporte General Ventas por Kiosco") // Titulo
    ->setSubject("Reporte General Ventas por Kiosco") //Asunto
    ->setDescription("Reporte de Ventas por Kiosco") //Descripción
    ->setKeywords("Reporte de Ventas por Kiosco") //Etiquetas
    ->setCategory("Reporte de Ventas por Kiosco"); //Categorias

    $tituloReporte = "Reporte General de Ventas por Kiosco";
    ...
    $queryText_Reporte = "
						...
						WHERE tm.Kiosco_ID_Kiosco = '".$ID_KC."' and tm.ID_Tipo_Transaccion_Monetaria IN (1,2);
   						";
	...
	$objPHPExcel->getActiveSheet()->setTitle('Ventas_por_Kiosco');
...
<div class="box">
	...
	<h1 class="title">Ventas por Kiosco</h1>
	<hr>
...
<div class="body">
			...
			<div class="sky-tabs sky-tabs-pos-top-left sky-tabs-anim-flip sky-tabs-response-to-icons">
				...
				<label for="sky-tab1"><span><span><i class="fa fa-bolt"></i>Reporte General Ventas por Kiosco</span></span></label>
				
				<ul>
					<li class="sky-tab-content-1">					
						<div class="">
							<h4>Reporte General Ventas por Kiosco</h4>
