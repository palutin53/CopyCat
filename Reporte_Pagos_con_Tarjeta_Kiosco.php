...
/** Se agrega la libreria PHPExcel */
    ...
    ->setTitle("Reporte General Pagos con Tarjeta Kiosco") // Titulo
    ->setSubject("Reporte General Pagos con Tarjeta Kiosco") //Asunto
    ->setDescription("Reporte de Pagos con Tarjeta Kiosco") //Descripción
    ->setKeywords("Reporte de Pagos con Tarjeta Kiosco") //Etiquetas
    ->setCategory("Reporte de Pagos con Tarjeta Kiosco"); //Categorias

    $tituloReporte = "Reporte General de Pagos con Tarjeta Kiosco";
    ...
    $queryText_Reporte = "
						...
						WHERE tm.Kiosco_ID_Kiosco = '".$ID_KC."' and tm.ID_Tipo_Transaccion_Monetaria = 2;
   						";
	...
	$objPHPExcel->getActiveSheet()->setTitle('Pagos_con_Tarjeta_Kiosco');
...
<div class="box">
	...
	<h1 class="title">Pagos con Tarjeta Kiosco</h1>
	<hr>
...
<div class="body">
			...
			<div class="sky-tabs sky-tabs-pos-top-left sky-tabs-anim-flip sky-tabs-response-to-icons">
				...
				<label for="sky-tab1"><span><span><i class="fa fa-bolt"></i>Reporte General Pagos con Tarjeta Kiosco</span></span></label>
				
				<ul>
					<li class="sky-tab-content-1">					
						<div class="">
							<h4>Reporte General Pagos con Tarjeta Kiosco</h4>
